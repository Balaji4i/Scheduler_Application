...
public class ScheduleFrag {
    ...
    public String invokeRWServices(String url) throws  IOException,
                                             JSONException {
            String defaultUserPass = "";
            String result=null;
          URL obj =new URL(url); //Local
            ...
            String resMsg = null;
         //   JSFUtils.addFacesInformationMessage("GET Response Code :  " + responseCode);
            System.out.println("GET Response Code :  " + responseCode);
            System.out.println("GET Response Message : " +
                               postConnection.getResponseMessage());
//            
//            JSFUtils.addFacesInformationMessage("GET Response Message : " +
//                               postConnection.getResponseMessage());
//            
            ...
            //    JSFUtils.addFacesInformationMessage("response.toString() :  " + response.toString());
            //    JSFUtils.addFacesInformationMessage("result :  " + result);
                System.out.println(response.toString());
                System.out.println(result);
            } else {
                System.out.println("GET NOT WORKED");
                JSFUtils.addFacesErrorMessage("Service is Temporarily down !!!");
            }
            return result;
        }

    public void invoke(ActionEvent actionEvent) throws IOException,
                                                       JSONException {
...
//        String startUrl ="http://140.238.225.85/oando/api/scheduler/start";
//          String startUrl ="http://events.4iapps.com/api/lease/scheduler/start";
        String startUrl ="https://jcs.omniyat.com:9000/lease_test/api/lease/scheduler/start";
        ...
        if (!freqMin.equals("null") && !freqMin.equals("0") &&
            ...
            invokeRWServices(startUrl);
           // st.runSchedule(sP);
       //     JSFUtils.addFacesInformationMessage("Calling is completed");
...
//        String stopUrl="http://140.238.225.85/oando/api/scheduler/stop";

//        String stopUrl="http://events.4iapps.com/api/lease/scheduler/stop";
        String stopUrl="https://jcs.omniyat.com:9000/lease_test/api/lease/scheduler/stop";
